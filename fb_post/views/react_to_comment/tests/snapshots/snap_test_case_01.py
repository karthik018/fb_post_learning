...
snapshots['TestCase01ReactToCommentAPITestCase::test_case reaction_user'] = GenericRepr("<User: username>")

snapshots['TestCase01ReactToCommentAPITestCase::test_case reaction_type'] = 'LIKE'
