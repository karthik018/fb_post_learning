...
class TestCommentReplies(unittest.TestCase):
    def test_comment_replies(self):
        ...
        get_comment_replies = CommentRepliesInteractor(post_storage_mock,
                                                       presenter_mock)
        ...
        response = get_comment_replies.get_comment_replies(comment_id, offset,
                                                           limit)

        post_storage_mock.is_comment_or_reply.assert_called_once_with(
                                                                    comment_id)
