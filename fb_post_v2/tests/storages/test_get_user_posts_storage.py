...
class TestUserPosts:
    ...
    def setup_data(self):
        ...
        self.post3 = Post.objects.create(user_id=self.user.id, post_description="third post")
    ...
    def test_user_posts(self, setup_data):
        ...
        userposts_dto = post_storage.get_user_posts(user_id=self.user.id, offset=0, limit=2)
